...
export ZSH="/Users/yves/.oh-my-zsh"
...
plugins=(colored-man-pages gitignore golang kubectl mvn spring vagrant)
...
# Completion
autoload bashcompinit && bashcompinit # bash-completion-support
autoload -Uz compinit && compinit # completion-support
